...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 26, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-75.163254, -17.496309, -70.654909, -14.106115], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEOLOGIA-AREQUIPA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (15 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@ALEX CASTREJON';
            }
